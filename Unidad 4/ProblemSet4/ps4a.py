...
def isValidWord(word, hand, wordList):
    ...
    #Check if the world is composed of letters in the current hand
    ...
    #Check if hand's letter are enought to spell the word

    played_word = getFrequencyDict(word)

    check_hand = hand.copy()

    for letter in played_word:

        check_hand[letter] -= played_word.get(letter)

    for letter in check_hand:
